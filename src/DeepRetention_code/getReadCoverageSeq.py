...
parser.add_argument('-w','--worker', default=20, help='Number of parallel processes')
parser.add_argument('-e','--eLen', default=25, help='the read length taken from exon')
parser.add_argument('-i','--iLen', default=50, help='the read length taken from intron')
